...
gmaps_key = 'AIzaSyB5S3vT7rNhnlFQEJmP6fHAnBN0NUT3xF8'
gstreet_key = 'AIzaSyC5_ykc-fx-ATeZyyXQgPH77cffoOEvobY'
ggeo_key = 'AIzaSyDl6oSwMjns7hY9dTNwGYPObwtUATJOG0w'
...
# converts 1600 Amphitheatre Parkway, Mountain View, CA to 1600+Amphitheatre+Parkway,+Mountain+View,+CA
...
def geo(address):
    ...
    #print(test_ggeo['geometry'][0].get('location'))
